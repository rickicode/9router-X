...
export default function TokenSaverClient() {
 ...
 <div className="flex items-center justify-between pt-2 pb-3 border-b border-border gap-3 h-8">
 ...
 <span
 className={`text-xs px-2 py-1 rounded-sm ${headroomRunning ? "bg-success/10 text-success" : "bg-warning/10 text-warning"}`}
 >
 {headroomStatusLabel}
 </span>
 <button
 ...
 <div className="mb-3 ml-1 pl-3 pb-3 border-l-2 border-border">
 ...
 <div
 key={extra}
 className="flex items-center gap-1.5 text-xs px-2 py-1 rounded-sm border border-success/30 bg-success/10 text-text"
 title={extraTitle}
 >
 <Toggle
 size="sm"
 ...
 <label
 key={extra}
 className={`flex items-center gap-1.5 text-xs px-2 py-1 rounded-sm border cursor-pointer ${
 pending
 ...
 className="text-xs px-2.5 py-1 rounded-sm bg-primary text-white hover:opacity-90 disabled:opacity-50"
 >
 {extrasActionLoading
 ? "Installing…"
 ...
 <pre className="mt-2 max-h-32 overflow-auto rounded-sm bg-surface whitespace-pre-wrap border border-border p-3 font-mono text-xs text-text-main">
 {installLog}
 </pre>
 )}
 ...
 className={`px-3 py-2 rounded-sm text-xs font-medium border ${
 cavemanLevel === lvl.id
 ...
 <div className="flex items-center justify-between pt-3 mt-4 border-t border-border gap-3 flex-wrap">
 <div className="min-w-0 flex-1">
 <p className="font-medium">
 Lazy senior dev{" "}
 <a
 ...
 <span className={`text-xs px-2 py-1 rounded-sm ${pxpipeChipClass}`}>
 {pxpipeStatusLabel}
 </span>
 <button
 type="button"
 ...
 target="_blank"
 rel="noreferrer"
 className="w-full rounded-sm border border-border px-3 h-8 text-center text-sm hover:bg-surface-2"
 >
 ...
 <pre className="flex-1 rounded-sm bg-surface font-mono overflow-x-auto border border-border p-3 text-sm text-text-main">
 ...
 className="col-span-2 rounded-sm border border-border px-3 h-8 text-center text-sm hover:bg-surface-2"
 >
 Open Logs
 </a>
 </div>
