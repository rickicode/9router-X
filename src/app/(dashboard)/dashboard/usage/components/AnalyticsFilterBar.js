...
className="h-full w-full bg-transparent text-xs text-text-main font-medium px-1.5 outline-none cursor-pointer"
 ...
 {provider && (
 <span className="inline-flex min-w-0 max-w-full items-center gap-1 px-2.5 rounded-sm bg-surface text-text-main border border-border [&>strong]:min-w-0 [&>strong]:[overflow-wrap:anywhere] [&>button]:shrink-0 h-8">
 ...
 {errorCategory && (
 <span className="inline-flex min-w-0 max-w-full items-center gap-1 px-2.5 py-1 rounded-sm bg-danger/10 text-danger border border-danger/30 [&>strong]:min-w-0 [&>strong]:[overflow-wrap:anywhere] [&>button]:shrink-0">
 Error:{" "}
 <strong>
