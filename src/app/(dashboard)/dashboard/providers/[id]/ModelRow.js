...
export default function ModelRow({ model, fullModel, alias, copied, onCopy, testStatus, isCustom, isFree, onDeleteAlias, onTest, isTesting, onDisable, caps, thinkingSuffix }) {
 ...
 return (
 <div className={`group min-w-0 max-w-full rounded-sm border px-3 h-8 ${borderColor} hover:bg-surface-2`}>
 ...
 <code className="max-w-[72vw] truncate rounded-sm bg-sidebar px-1.5 py-1 font-mono text-xs text-text-muted sm:max-w-[360px]">{displayModel}</code>
