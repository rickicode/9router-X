...
import { Card, Button, Badge, Input, CardSkeleton, Toggle, Select } from "@/shared/components";
...
const NoAuthProxyCard = dynamic(() => import("@/shared/components/NoAuthProxyCard"), { ssr: false, loading: () => <CardSkeleton /> });
...
const Modal = dynamic(() => import("@/shared/components/Modal"), { ssr: false, loading: ModalSkeleton });
