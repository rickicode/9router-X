...
export default function MitmServerCard({ apiKeys, cloudEnabled, onStatusChange }) {
 ...
 return (
 <>
 <Card padding="sm" className="border-primary/30 bg-primary/10">
 ...
 <span key={label} className={`flex items-center gap-0.5 px-1.5 py-1 rounded-sm ${ok ? "text-success" : "text-text-muted"}`}>
 ...
 <div className="p-3 rounded-sm bg-surface border border-border flex flex-col gap-2">
 ...
 <span className="text-xs font-medium text-text-main sm:text-right sm:text-sm">9Router Base URL</span>
 ...
 disabled={isRunning}
 className="flex-1 min-w-0 px-2 py-2 bg-surface rounded-sm border border-border text-xs text-text-main focus:outline-none disabled:opacity-50"
 />
 </div>
 {!isRunning && (
 <div className="grid gap-1 sm:grid-cols-[8rem_auto_1fr] sm:items-center sm:gap-2">
 ...
 className="flex-1 min-w-0 px-2 py-2 bg-surface rounded-sm border border-border text-xs text-text-main focus:outline-none"
 />
 {apiKeys?.length > 0 && (
 ...
 disabled={loading}
 className="flex w-full items-center justify-center gap-1.5 rounded-sm border border-warning/30 bg-warning/10 px-3 h-8 text-xs font-medium text-warning hover:bg-warning/10 disabled:opacity-50 sm:w-auto sm:py-2"
 >
 ...
 disabled={loading}
 className="flex w-full items-center justify-center gap-1.5 rounded-sm border border-danger/30 bg-danger/10 px-3 h-8 text-xs font-medium text-danger hover:bg-danger/10 disabled:opacity-50 sm:w-auto sm:py-2"
 >
 ...
 className="flex w-full items-center justify-center gap-1.5 rounded-sm border border-primary/30 bg-primary/10 px-3 h-8 text-xs font-medium text-primary hover:bg-primary/10 disabled:opacity-50 sm:w-auto sm:py-2"
 >
 ...
 {/* Action error */}
 {actionError && (
 <div className="flex items-start gap-2 px-2 py-2 rounded-sm text-xs bg-danger/10 text-danger border border-danger/30">
 ...
 <div className="flex items-center gap-2 px-2 py-2 rounded-sm text-xs bg-danger/10 text-danger border border-danger/30">
 ...
 />
 {modalError && (
 <div className="flex items-center gap-2 px-2 py-2 rounded-sm text-xs bg-danger/10 text-danger">
