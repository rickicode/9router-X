...
export default function ProxyFitnessPage() {
 ...
 <h2 className="text-sm font-semibold text-text-main">Blocks</h2>
 ...
 {/* Filters */}
 <div className="flex flex-wrap items-end gap-3 rounded-sm border border-border bg-surface p-3">
 ...
 {providerMenuOpen && (
 <div className={`absolute left-0 z-20 w-full max-h-72 overflow-y-auto rounded-sm border border-border bg-surface size-8 ${providerMenuDropUp ? "bottom-full mb-1" : "top-full mt-1"}`}>
 <button
 type="button"
 onClick={() => { setProviderFilter("all"); setProviderMenuOpen(false); }}
 className={`flex w-full items-center gap-3 rounded-sm px-3 h-8 text-left text-sm ${providerFilter === "all" ? "bg-primary/10 text-primary" : "text-text-main hover:bg-surface-2"}`}
 >
 ...
 className={`flex w-full items-center gap-3 rounded-sm px-3 h-8 text-left text-sm ${providerFilter === provider ? "bg-primary/10 text-primary" : "text-text-main hover:bg-surface-2"}`}
 >
 ...
 <th className="px-3 h-8 text-xs font-medium text-text-muted">Provider</th>
 <th className="px-3 h-8 text-xs font-medium text-text-muted">Model</th>
 <th className="px-3 h-8 text-xs font-medium text-text-muted">IP / Proxy</th>
 <th className="px-3 h-8 text-xs font-medium text-text-muted">Pool</th>
 <th className="px-3 h-8 text-xs font-medium text-text-muted">Reason</th>
 <th className="px-3 h-8 text-xs font-medium text-text-muted">Until</th>
 <th className="px-3 h-8 text-right text-xs font-medium text-text-muted">Actions</th>
 </tr>
 </thead>
 <tbody>
