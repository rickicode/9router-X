            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Point your CLI tools to http://localhost:10128</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                ...
                <div className="text-gray-400 mb-6">
                  ...
                  <span className="text-[#f97815]">&gt;</span> Server running on <span className="text-blue-400">http://localhost:10128</span><br/>
                  <span className="text-[#f97815]">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:10128/dashboard</span><br/>
