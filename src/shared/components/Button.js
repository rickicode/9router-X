...
const variants = {
 primary: "bg-primary text-white hover:bg-primary-hover disabled:bg-surface-3 disabled:text-text-muted",
 ...
 danger: "bg-danger text-white hover:bg-danger disabled:bg-surface-3 disabled:text-text-muted",
 success: "bg-success text-white hover:bg-success disabled:bg-surface-3 disabled:text-text-muted",
};
